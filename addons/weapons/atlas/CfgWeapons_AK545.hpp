...
class CLASS(arifle_AK12_green): arifle_AK12_545_F {
    displayName = "AK-12 (Green)";
    baseWeapon = QCLASS(arifle_AK12_green);
    AK_GREEN;
};
...
class CLASS(arifle_RPK12_green): Aegis_arifle_RPK12_545_F {
    displayName = "RPK-12 (Green)";
    baseWeapon = QCLASS(arifle_RPK12_green);
    RPK_GREEN;
};
